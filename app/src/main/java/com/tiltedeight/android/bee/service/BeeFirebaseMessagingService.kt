package com.tiltedeight.android.bee.service
...
class BeeFirebaseMessagingService: FirebaseMessagingService() {
...
//        WorkManager.getInstance().beginWith(work).enqueue()
    ...
    private fun sendNotification(messageBody: String) {
        val intent = Intent(this, RegisterDeviceContactActivity::class.java)
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(R.drawable.outline_email_24)
